...
namespace nowide {
///
/// \brief Template function that converts a buffer of UTF sequences in range
...
CharOut* basic_convert(CharOut* buffer, size_t buffer_size, CharIn const* source_begin,
